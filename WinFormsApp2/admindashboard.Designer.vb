...
Partial Class admindashboardform
    ...
    Private Sub InitializeComponent()
        ...
        nav_panel.Size = New Size(230, 972)
        ...
        search_btn_dept.Location = New Point(324, 18)
        search_btn_dept.Margin = New Padding(4, 5, 4, 5)
        search_btn_dept.Name = "search_btn_dept"
        search_btn_dept.Size = New Size(107, 38)
        ...
        ' Button3
        ' 
        Button3.Location = New Point(605, 117)
        Button3.Name = "Button3"
        Button3.Size = New Size(139, 51)
        Button3.TabIndex = 21
        Button3.Text = "Export Report"
        Button3.UseVisualStyleBackColor = True
        ' 
        ' Button2
        ' 
        Button2.Location = New Point(459, 117)
        ...
        DataGridView1.Size = New Size(1140, 623)
        DataGridView1.TabIndex = 19
        ' 
        ' ComboBox1
        ' 
        ComboBox1.FormattingEnabled = True
        ComboBox1.Location = New Point(212, 127)
        ...
        ' Button4
        ' 
        Button4.Location = New Point(795, 128)
