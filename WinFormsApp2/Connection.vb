...
Module Connection
    ...
    Private conString = "server=sql12.freesqldatabase.com;user=sql12665374;password=rWT73f2vYC;database=sql12665374;charset=utf8; Convert Zero Datetime=True; Allow User Variables=True"
